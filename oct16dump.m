function oct16dump(fileinput, fileoutput, ncols)
% oct16dump(filenm, n, ncols)
% Write the content of the binary file 'fileinput' in 2-byte octal int form into 
